...
public class Cliente implements Serializable {
	...
	@OneToOne
	//Faz referencia ao codigo do cliente, ou seja 
	//o codigo do endereco será o mesmo valor do codigo do cliente. 
	@PrimaryKeyJoinColumn(name = "cod_cliente")
	private Endereco endereco;
	
	//O atributo 'mappedBy', indica que será um relacionamento bi-direcional,
	//isso siginifica que a classe Cliente carregar Locação, 
	//como a classe Locacao pode carregar Cliente.
